...
// Internal imports
import headerConstruction from './rules/headerConstruction.js';
...
// plugins.hexios.businessRules.rulesLibrary.
 ...
 * but could be really confusing if yuo are struggling, trying to debug commands or business rules that do not appear to exist.
 */
async function initPluginRulesLibrary() {
  ...
  returnData[sys.cbusinessRules] = {
    // Business Rules
    // ***********************************************************************
    // BEGIN headerConstruction category
    // ***********************************************************************
    [plg_biz.cmapHeaderMetaDataToBusinessRule]: (inputData, inputMetaData) => headerConstruction.mapHeaderMetaDataToBusinessRule(inputData, inputMetaData)
    // ***********************************************************************
    // END headerConstruction category
    // ***********************************************************************
  };
