 ...
 * @description Loads teh plugin command aliases data by calling the Haystacks to
 * load and parse teh data from the specified path.
 * @param {string} aliasesPath The fully qualified path to the command aliases folder with al of the command aliases data for the plugin.
