...
const {bas, phn, sys, wrd} = hayConst;
...
export const cExpectedActualPluginDevName = phn.chex + phn.cios; // hexios
export const cExpectedActualPluginProdName = phn.chex + phn.cios; // hexios
